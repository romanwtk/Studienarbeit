...
\section{Anwendungen von Reed-Solomon-Codes}
...
\subsection{QR-Codes}
\subsubsection{Hintergrund und Konzept}
...
\subsubsection{Konstruktion von Fehlerkorrekturworten}
...
\item Falls $\sigma(\alpha^j) = 0, \, j \in \lbrace 0, ..., n-1 \rbrace$, so liegt an dieser Stelle $j$ ein Fehler vor.
