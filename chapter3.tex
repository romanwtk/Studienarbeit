...
\end{itemize}
Da die Matrix $P$ pro Spalte genau in einer Komponente einen Wert ungleich $0$ aufweist, 
führt eine Multiplikation der Matrix $H$ mit $P$ lediglich zu Spaltenvertauschungen und skalaren Multiplikationen, weshalb das Produkt $HP$ einen äquivalenten Code bildet.
\end{proof}
...
\end{itemize}
Als geeignete Codes werden \textit{Goppa}-Codes als Teil der \textit{Alterant Codes}, algebraisch-geometrische Codes und \textit{Reed-Solomon-Codes} vorgestellt, da sie die \textit{Gilbert-Varshamov-Grenze} einhalten \parencite[vgl. ][S. 162]{Niederreiter1986}.