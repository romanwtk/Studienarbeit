...
\end{definition}
Verwendet werden im Folgenden binäre \textit{Goppa}-Codes mit Körper $GF(2^m)$, Länge $\lvert L \rvert = 2^m$ und Goppapolynom $g(z)$ mit Grad $t$, wobei $t$ die maximale Fehlerkorrekturkapazität angibt. Die Dimension des Codes ist definiert durch $k \geq n - t \cdot m$.