...
\subsection{Felder}
\begin{definition}
Ein \textbf{Ring} $(R, +, \circ)$ ist eine Menge $R$ mit den zwei auf ihr definierten binären Relationen, notiert durch $+$ und $\circ$, für die gilt:
\begin{itemize}
...
\end{itemize}
Ein Ring ist \textbf{kommutativ}, wenn die Operation $\circ$ kommutativ ist. Ferner ist ein Ring ein \textbf{Divisionsring}, falls $(R \setminus \lbrace 0 \rbrace , \circ )$ eine Gruppe bildet \parencite[vgl. ][S. 13]{Niederreiter97}. 
\end{definition}
\begin{definition}
Ein kommutativer Divisionring wird als \textbf{Feld} bezeichnet \parencite[vgl. ][S. 13]{Niederreiter97}. 
\end{definition}
