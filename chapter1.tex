...
\begin{definition}
Seien $a = \langle a_1, a_2, ..., a_n \rangle$, $b = \langle b_1, b_2, ..., b_n \rangle \in A^n$ und $A$ ein Alphabet, so ist die \textbf{Hamming-Distanz} $d$ von zwei Codewörtern $a$ und $b$ definiert als die Anzahl der abweichenden Stellen in $a$ und $b$:
