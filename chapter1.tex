...
\[m = \langle a_0, a_2, ..., a_{n-2}, a_{n-1} \rangle \quad \forall i = 0, ..., n-1\colon \, a_i \in \Sigma\]
\end{definition}
...
\begin{definition}
Seien $a = \langle a_0, a_2, ..., a_{n-1} \rangle$, $b = \langle b_0, b_2, ..., b_{n-1} \rangle \in A^n$ und $A$ ein Alphabet, so ist die \textbf{\textsc{Hamming}-Distanz} $d$ eine Metrik auf $A^n$. Sie ist definiert als die Anzahl der abweichenden Stellen in zwei Codeworten $a$ und $b$:
