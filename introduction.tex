...
child { node {Quellencodierung} 
	child { node {Kompression} }
	child { node {Huffman / Fano} }	
}
child { node[concept color=orange!70] {Kanal-codierung} 
	child { node[concept color=orange!70] {Blockcodes} 
		child { node[concept color=orange!70] {Fehlerkorrektur} }
		child { node[concept color=orange!70] {Linearität} }	
	}
...
child { node[concept color=orange!70] {Kryptographie} 
	...
	child { node[concept color=orange!70] {Quantenresistenz} }
};
\end{tikzpicture}
